...
filename = [DD.PROC '/surrogate2_' OUTSTR '_' , num2str(SPK_THR) , '_spk.mat'] ; 
save(filename,'simlens','-v7.3')

filename = [DD.PROC '/surrogate2_' OUTSTR '_' , num2str(SPK_THR) , '_spkcount.mat'] ; 
save(filename,'simmat','simvar','-v7.3')

filename = [DD.PROC '/surrogate2_' OUTSTR '_' , num2str(SPK_THR) , '_spkrss.mat'] ; 
